...
functs_rtype = \
{
    ...
    "SLT":     ("010", "0", lambda a,b: (0,1)[comp(a,b)], lambda a: a, lambda b: b),
    "SLTU":    ("011", "0", lambda a,b: (0,1)[(a & 0xffffffff) < (b & 0xffffffff)], lambda a: a, lambda b: b),
    "XOR":     ("100", "0", lambda a,b: a ^ b, lambda a: a, lambda b: b),
    "SRL":     ("101", "0", lambda a,b: (a & 0xffffffff) >> (b & 0x1f), lambda a: a, lambda b: b),
    "SRA":     ("101", "1", lambda a,b: sra(a, b & 0x1f), lambda a: a, lambda b: b),
